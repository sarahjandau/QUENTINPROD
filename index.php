...
<div class="cookie-consent">
    <div class="cookie-popin">
        <div class="title">Respect de la vie privée</div>
        <div class="description">Nous utilisons des cookies sur notre site Web dans le but d'améliorer continuellement votre expérience. Pour plus d'informations, veuillez consulter notre <a target="_blank" href="#">Politique de confidentialité</a>.
        </div>
        <div class="user-choice">
            <div class="auth-button">Accepter</div>
        </div>
    </div>
